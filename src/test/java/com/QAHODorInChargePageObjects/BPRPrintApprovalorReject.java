...
public class BPRPrintApprovalorReject extends BRMSCommonMethods {
	...
	public void setbprbatchnumber() throws IOException {
		 batchno1 = batchnumber1.getText();
		 batchno1=batchno1.substring(20, 29);
	excelutils.writecellvalues(excelFilePath,"BPRproductdetails", batchno1,2,14);
}
...
//		clickElement(tab);
	...
	public void batchnumber() throws InterruptedException {
		javascript(batchnumber);
		uniqueId=getNextId();
		Thread.sleep(3000);
		batchnumber.sendKeys(uniqueId);
	}
   public void comments1(String comm) throws IOException, InterruptedException {
