...
public class AdditionalPageRePrintReview extends BRMSCommonMethods
	{
		...
		WebElement tab2;
		@FindBy(how = How.XPATH, using = "//span[text()='Additional Page Reprint Request Approval']")
		WebElement additionalreprintreqapproval;
		...
		WebElement submit;
		public AdditionalPageRePrintReview(WebDriver driver) {
			PageFactory.initElements(driver, this);	
		}

		public void addreprintreqapprovaltab() throws IOException, InterruptedException {
			javawait();
		//	clickElement(tab);
		//	clickElement(tab2);
			javascript(additionalreprintreqapproval);
