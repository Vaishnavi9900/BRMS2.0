...
//		 options.addArguments("--headless=new"); //headless testing(without UI)
//		 options.addArguments("disable-infobars"); 
//		 options.setAcceptInsecureCerts(true); // accepting the SSL Certicates;
////		 options.setExperimentalOption("excludedSwitches", new String[]
////		 {"enable-automation"}); //disable the chrome being controlled by automated
//		// alert
//		 options.addArguments("--incognito"); //to run the tests in incognito mode.
//		 options.addArguments("--disable-blink-features=AutomationControlled");
//		 options.setExperimentalOption("excludeSwitches", new String[]{"enable-automation"});
//	        options.setExperimentalOption("useAutomationExtension", false);
//	        options.addArguments("--disable-blink-features=AutomationControlled");
//	        options.addArguments("--disable-infobars"); // Deprecated but still sometimes helps
//	        options.addArguments("--start-maximized");
		...
		driver.get("http://172.16.5.167:9095/brms2.0_enhancement_v1/client");
...
//		}
	 ...
	 private static int counter = 15; // starts from 0

	    public static synchronized String getNextId() {
	        String prefix = "CUS-ATN-25-";
	        String formatted = String.format("%02d", counter);
	        counter=counter+1;
...
//		extetentTest.assignCategory(m.getAnnotation(Test.class).groups()); // for groups.
	...
	public String CaptureScreenshot(String fileName) {
		...
		// File destfile = new File("./FailedScreenshots/" +screenshotsubfoldername+"/
		// "+fileName);
		File destfile = new File(System.getProperty("user.dir") + "//FailedScreenshots//" + screenshotsubfoldername
				+ " " + fileName + ".jpg");
		...
		return System.getProperty("user.dir") + "//FailedScreenshots//" + screenshotsubfoldername + " " + fileName
				+ ".jpg";
	}
	...
	public String getPreviousDate() {
		...
		DateTimeFormatter df = DateTimeFormatter.ofPattern("dd-MM-yyyy");
		String actualdate = df.format(newDate);
	...
	public void frames() {
		...
		driver.switchTo().defaultContent(); // to go back
