...
import com.QAOfficerPageObjects.AdditionalPageRePrintRequestInitiation;
import com.aventstack.extentreports.Status;

public class AdditionalPageRePrintReqInitiation extends ConfigurationReader
	{

		public Assignmenu as;
		public AdditionalPageRePrintRequestInitiation reprint;
		
		@Test
		public void AdditionalrePrintInitiation() throws InterruptedException, IOException {
			as = new Assignmenu(driver);
			reprint = new AdditionalPageRePrintRequestInitiation(driver);
			...
			reprint.addreprintreqinitiationtab();
			LoggerUtil.logInfo("clicked on Additional RePrint Req. Initiation tab and opened the record");
			extenttest.log(Status.PASS, "clicked on Additional RePrint Req. Initiation tab and opened the record");
...
//			LoggerUtil.logInfo("clicked on submit");
			...
			extenttest.log(Status.PASS, "Logout from the application");
				...
				LoggerUtil.logError("BMR Additional RePrint Req. Initiation Test is failed", e);
		...
		@Test
		public void AdditionalrePrintReInitiation() throws InterruptedException, IOException {
			as = new Assignmenu(driver);
			reprint = new AdditionalPageRePrintRequestInitiation(driver);
			...
			LoggerUtil.logInfo("Login to the application with QA Officer id and password");
			extenttest.log(Status.PASS, "Login to the application with QA Officer id" +getQAOfficer()+" and password as "+getpassword()+ " ");
			reprint.addreprintreqReinitiationtab();
			LoggerUtil.logInfo("clicked on Additional RePrint Req. Initiation tab");
			extenttest.log(Status.PASS, "clicked on Additional RePrint Req. Initiation tab");
			...
			extenttest.log(Status.PASS, "Logout from the application");
				...
				LoggerUtil.logError("BMR Additional RePrint Req. ReInitiation Test is failed", e);
		            // Log the failure to ExtentReports
		            extenttest.fail("Test failed: " + e.getMessage());
		            // Optionally, you can log the stack trace if needed
		            extenttest.fail(e);
