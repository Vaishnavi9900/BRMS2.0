...
public class BMRBPRValidationInchargePrintReview extends BRMSCommonMethods{
	...
	@FindBy(how = How.XPATH, using = "(//button[@data-dismiss='modal'])[8]")
	WebElement Yes;
	@FindBy(how = How.XPATH, using = "(//button[@data-dismiss='modal'])[7]")
	WebElement No;
	...
	public void submitactivity(String pass) throws InterruptedException {
		...
		clickElement(submitNo);
		clickElement(submit);
		clickElement(submitYes);
		javawait();
