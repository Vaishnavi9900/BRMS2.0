...
public class BMRPrintIssuanceInitiationandReceived extends BRMSCommonMethods {
	...
	public void standardbatchnumber(String batchno) throws IOException, InterruptedException {
		excelutils.setExcelFile(excelFilePath, "productdetails");
		for (int i = 1; i < 2; i++) {
			mprnumber.click();
	...
	public void commonbatchnumber(String batchno) throws IOException, InterruptedException {
		excelutils.setExcelFile(excelFilePath, "productdetails");
		for (int i = 1; i < 2; i++) {
			mprnumber.click();
