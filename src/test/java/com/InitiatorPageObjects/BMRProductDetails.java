...
public class BMRProductDetails extends BRMSCommonMethods {
	...
	WebElement tab2;
	@FindBy(how = How.XPATH, using = "//span[text()='Product Details Initiation']")
	...
	WebElement block;
	@FindBy(how = How.XPATH, using = "//div[text()='Dispensing/Weighing']")
	WebElement oncoblocksel;
	@FindBy(how = How.XPATH, using = "//div[text()='Finished Goods Area']")
	WebElement oncoblocksel2;
	@FindBy(how = How.XPATH, using = "//div[text()='Block-A']")
	WebElement blocksel;
	@FindBy(how = How.XPATH, using = "//div[text()='Block-C']")
	WebElement blocksel2;
	@FindBy(how = How.XPATH, using = "(//span[@class='dropdown-btn'])[2]")
	WebElement location;
	@FindBy(how = How.XPATH, using = "//div[text()='stability']")
	WebElement oncolocsel;
	@FindBy(how = How.XPATH, using = "//div[text()='Quality Block']")
	WebElement oncolocsel2;
	@FindBy(how = How.XPATH, using = "//div[text()='Line-M']")
	WebElement locsel;
	@FindBy(how = How.XPATH, using = "//div[text()='Line-N']")
	WebElement locsel2;
	...
	@FindBy(how = How.XPATH, using = "//div[@class='modal-sm modalSm modal-dialog-centered']//div[@class='modal-body modal-bodyBox text-center']")
...
//			blendselect1.get(count-1).click();
		...
		try {
		   ...
		   wait.until(ExpectedConditions.visibilityOf(generaltext));
		    if (generaltext.isDisplayed()) {
		        javascript(blocksel); // Click General Block
		    }
		} catch (Exception e) {
			if (oncotext.isDisplayed()) {
		        javascript(oncoblocksel); // Click Onco Block
			}
		}
	}
	...
	public void block1() throws InterruptedException {
		try {
		   ...
		   wait.until(ExpectedConditions.visibilityOf(generaltext));
		    if (generaltext.isDisplayed()) {
		        javascript(blocksel2); // Click General Block
		    }
		} catch (Exception e) {
			if (oncotext.isDisplayed()) {
		        javascript(oncoblocksel2); // Click Onco Block
			}
		}
		}
	...
	public void location() throws InterruptedException {
		try {
		   ...
		   wait.until(ExpectedConditions.visibilityOf(generaltext));
		    if (generaltext.isDisplayed()) {
		        javascript(locsel); // Click General Block
		    }
		} catch (Exception e) {
			if (oncotext.isDisplayed()) {
		        javascript(oncolocsel); // Click Onco Block
			}
		}
	}
	...
	public void location1() throws InterruptedException {
		try {
		   ...
		   wait.until(ExpectedConditions.visibilityOf(generaltext));
		    if (generaltext.isDisplayed()) {
		        javascript(locsel2); // Click General Block
		    }
		} catch (Exception e) {
			if (oncotext.isDisplayed()) {
		        javascript(oncolocsel2); // Click Onco Block
			}
		}
	}
