...
public class AdditionalPageRePrintRequestInitiation extends BRMSCommonMethods
	{
		...
		WebElement tab2;
		@FindBy(how = How.XPATH, using = "//span[text()='Additional Page Reprint Request Initiation']")
		WebElement additionalreprintreqinitiation;
		...
		WebElement select;
		@FindBy(how = How.XPATH, using = "(//input[@placeholder='No of Copies'])[1]")
		...
		public AdditionalPageRePrintRequestInitiation(WebDriver driver) {
			PageFactory.initElements(driver, this);	
		}

		public void addreprintreqinitiationtab() throws IOException, InterruptedException {
			javawait();
		//	clickElement(tab);
		//	clickElement(tab2);
			javascript(additionalreprintreqinitiation);
		...
		public void addreprintreqReinitiationtab() throws IOException, InterruptedException {
			javawait();
		//	clickElement(tab);
		//	clickElement(tab2);
			javascript(additionalreprintreqinitiation);
...
//			clickElement(delete);
		...
		public void issueactivity(String pass) throws InterruptedException {
