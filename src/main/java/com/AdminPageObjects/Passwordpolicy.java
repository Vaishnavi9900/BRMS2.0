...
public class Passwordpolicy extends BRMSCommonMethods {
	...
	@FindBy(xpath = "//a[text()=' Password Policy ']") WebElement passwordpolicy;
	@FindBy(xpath = "//select[@id='PasswordPolicyPlantList']") WebElement plant;
	@FindBy(xpath = "//button[text()=' Update']") WebElement update;
	@FindBy(xpath = "//button[text()='OK']") WebElement nochangesok;
	@FindBy(xpath = "//input[@formcontrolname='expiryDays']") WebElement passwordexpiry;
	@FindBy(xpath = "//input[@formcontrolname='maxInvalidCount']") WebElement invalidattempts;
	@FindBy(xpath = "//input[@formcontrolname='expiryAlertDays']") WebElement expalertdays;
	@FindBy(xpath = "//input[@formcontrolname='length']") WebElement minlength;
	@FindBy(xpath = "//input[@formcontrolname='historyCount']") WebElement enforcepasshistory;
	@FindBy(xpath = "//input[@formcontrolname='uppercaseCount']") WebElement minuppercase;
	@FindBy(xpath = "//input[@formcontrolname='lowerCaseCount']") WebElement minlowercase;
	@FindBy(xpath = "//input[@formcontrolname='numericCount']") WebElement mindigits;
	@FindBy(xpath = "//input[@formcontrolname='specialCharactersCount']") WebElement minspecial;
...
public void passwordpolicycharacters(String minup, String minlow, String digits, String special ) throws InterruptedException {
