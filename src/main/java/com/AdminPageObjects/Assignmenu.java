...
public class Assignmenu extends BRMSCommonMethods {
	...
	@FindBy(xpath = "//div[text()=' Please Enter UserId and Password ']") WebElement alert;
	@FindBy(xpath = "//input[@formcontrolname='loginId']") WebElement loginid;
	@FindBy(xpath = "//input[@formcontrolname='password']") WebElement password;
	@FindBy(xpath = "//i[@class='fa fa-eye']") WebElement passwordview;
	@FindBy(xpath = "//li[@class='navLink']") WebElement menu;
	@FindBy(xpath = "//a[text()=' Assign Menu ']") WebElement assignmenu;
	@FindBy(xpath = "//button[@id='button-basic']") WebElement role;
	@FindBy(xpath = "//a[text()='MPR Initiator']") WebElement initiatorrole;
	@FindBy(xpath = "/html/body/app-root/div[1]/div/div/app-assign-menu/div/div/div[1]/nav/ol/li[1]/a") WebElement dashboardhyperlink;
	@FindBy(xpath = "//a[text()='MPR Initiator']") WebElement initiator;
	@FindBy(xpath = "//button[text()=' Update '] ") WebElement update;
	@FindBy(xpath = "//button[text()='OK']") WebElement nochangesok;
	@FindBy(xpath = "//label[text()='Select All'] ") WebElement selectall;
	@FindBy(xpath = "(//input[@class='checkbox'])[2]") WebElement singleselect;
