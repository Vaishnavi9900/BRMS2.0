...
public class BMRBPRAdditionalPrintReview extends BRMSCommonMethods{
	...
	WebElement tab;
	@FindBy(how = How.XPATH, using = "//span[text()='Additional Page Print Request Review']")
	WebElement additionalpageprintreqreview;
